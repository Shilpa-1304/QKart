...
const addProductToCart = catchAsync(async (req, res) => {
  console.log("Inside addProducttoCart controller");
  let cart = await cartService.addProductToCart(
...
const updateProductInCart = catchAsync(async (req, res) => {
  ...
  const updatedCart=await cartService.updateProductInCart(req.user,req.body.productId,req.body.quantity)
